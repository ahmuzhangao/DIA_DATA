...
CFG_TYPE_FLOW = {'DIA_Label_Free': 0, 'DIA_Evidence_Check': 1, 'DIA_Generate_Data_For_Train': 2, 'DIA_Train' : 3}  # 在Staff中用到，判断进入不同的Flow
...
TIME_EXPIRATION = {'Year': 2024, 'Month': 12, 'Day': 31}
